...
public class CustomerRepositoryOverEventStore extends RepositoryOverEventStore<Customer> implements CustomerRepository{
	...
	public CustomerRepositoryOverEventStore(EventStore eventStore, Class<Customer> customerClass) {

		super(eventStore, customerClass);
	}

	public CustomerRepositoryOverEventStore(EventStore eventStore,
		SnapshotStore snapshotStore,
		UniqueValuesStore uniqueValuesStore, Class<Customer> customerClass) {
