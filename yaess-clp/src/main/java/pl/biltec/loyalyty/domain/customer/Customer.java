...
import pl.biltec.loyalyty.domain.customer.exception.CustomerNotExistsException;
import pl.biltec.loyalyty.domain.customer.exception.UnsupportedEventException;
...
public class Customer {
	...
	private void mutate(CustomerCreatedEvent event) {
		...
		this.creationTimestamp = event.getCreated();
	}

	private void mutate(CustomerRenamedEvent event) {

		this.name = event.getNewName();
		this.lastUpdateTimestamp = event.getCreated();
	}
}
